...
export default function Volunteer() {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 relative bg-white dark:bg-slate-900 overflow-hidden">
          ...
          {volunteerPrograms.map((program, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative rounded-3xl p-8 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden"
              >
